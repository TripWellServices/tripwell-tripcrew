/**
 * Saved experiences (wishlist) — traveler-scoped list with optional crew context for navigation only.
 */
...
export default function WishlistView({ wishlistBackHref = '/wishlist' }: { wishlistBackHref?: string }) {
  ...
  const [selectedExperienceWishlistId, setSelectedExperienceWishlistId] = useState<string | null>(
    null
  )
